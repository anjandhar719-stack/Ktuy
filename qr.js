                            ...
                            await sock.sendMessage(sock.user.id, {
                                ...
                                contextInfo: {
                                    ...
                                    forwardedNewsletterMessageInfo: {
                                        newsletterJid: '1202325089913@newsletter',
...
> © 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 𝐀𝐧𝐣𝐚𝐧 𝐓𝐞𝐜𝐡`;
                            ...
                            await sock.sendMessage(sock.user.id, {
                                ...
                                contextInfo: {
                                    ...
                                    forwardedNewsletterMessageInfo: {
                                        newsletterJid: '1203634023913@newsletter',
                                        newsletterName: '© Anjan Tech',
                                        serverMessageId: Math.floor(Math.random() * 1000000)
                                    },
                                    isForwarded: true,
            ...
            await removeFile('./temp/' + id);
            if (!res.headersSent) {
                await res.send({ code: "❗ ANJA-MD Service Unavailable" });
            }
        }
    }
...
setInterval(() => {
    console.log("🔄 ANJA-MD Restarting process...");
    process.exit();
}, 1800000); // 30 minutes
